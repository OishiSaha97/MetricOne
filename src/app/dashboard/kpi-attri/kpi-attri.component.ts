...
import {KpiAttriPopUpComponent} from "./kpi-attri-pop-up/kpi-attri-pop-up.component";

@Component({
  selector: 'app-kpi-attri',
  templateUrl: './kpi-attri.component.html',
  styleUrls: ['./kpi-attri.component.css']
})
export class KpiAttriComponent {
  ...
  userList = [
    ...
    { configuredName: "Ian Config", configuredType: "Type B", createdBy: "Ian", createdOn: "2025-01-10", updatedBy: "Jack", updatedOn: "2025-01-19", action: "" }
     ...
     edit()
     {
          this.modalRef = this.modalService.show(KpiAttriPopUpComponent,{
